<div id="dashboard_menu" class="w-1/5 m-4 bg-[#8cd0e3]  relative">
        ...
        <ul class="text-white tracking-widest text-xl font-bold capitalize">
          <li
            class=" hover:border-[#5ec8e6] border-b border-white flex items-center py-3 my-2 hover:bg-[#5ec8e6] transition-all duration-500">
            ...
            <a href="" class="bg-white text-[#5ec8e6] hover:text-[#479ab0] mr-4 ml-auto">
