<div id="dashboard_menu" class=" m-4 bg-[#8cd0e3]  relative">
  ...
  <ul class="text-white tracking-widest text-xl font-bold capitalize">
    <li class=" hover:border-[#399ab5] border-b border-white flex items-center  my-2 hover:bg-[#399ab5] transition-all duration-500">
      <a href="<?= ROOT ?>dashboard" class="flex items-center py-3">
        ...
        <h1 class="max-[1100px]:hidden">produits</h1>
      </a>
    ...
    <li class=" hover:border-[#399ab5] border-b border-white flex items-center  my-2 hover:bg-[#399ab5] transition-all duration-500">
      <a href="<?= ROOT ?>dashboard/categories" class="flex items-center py-3">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mx-4">
        ...
        <h1 class="max-[1100px]:hidden">categories</h1>
      </a>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z" />
        ...
        <h1 class="max-[1100px]:hidden">Admin</h1>
      </a>
      <a href="<?= ROOT ?>newadmin" class="bg-white text-[#399ab5] hover:text-[#479ab0] mr-4 ml-auto">
        <svg class="w-6 h-6 " xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
          <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
        </svg>
      </a>
    ...
    <li class=" hover:border-[#399ab5] border-b border-white flex items-center  my-2 hover:bg-[#399ab5] transition-all duration-500">
      <a href="<?= ROOT ?>dashboard/statistics" class="flex items-center py-3">

        <svg class="w-6 h-6 mx-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
        ...
        <h1 class="max-[1100px]:hidden">statistics</h1>
      </a>
    </li>
