    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            ...
            <div class="  bg-[#8cd0e3] relative p-6">
                ...
                <div class="flex justify-between mt-4">
                    ...
                    <h3 class="text-lg font-bold "><?=$data['cards']['most_priftable_product']['gain']?></h3>
                </div>
            </div>
            ...
            <div class="  bg-[#8cd0e3] relative p-6">
                ...
                <div class="flex justify-between mt-4">
                    ...
                    <h3 class="text-lg font-medium"><?=$data['cards']['least_priftable_product']['gain']?></h3>
                </div>
            </div>
            ...
            <div class="  bg-[#8cd0e3] relative p-6">
                ...
                <div class="flex justify-between mt-4">
                    ...
                    <h3 class="text-lg font-medium"><?=$data['cards']['most_expenssive_item']['prix_vente']?></h3>
                </div>
            </div>
            ...
            <div class="  bg-[#8cd0e3] relative p-6">
                ...
                <div class="flex justify-between mt-4">
                    ...
                    <h3 class="text-lg font-medium"><?=$data['cards']['least_quantity']['quantite']?></h3>
                </div>
            </div>
        </div>
